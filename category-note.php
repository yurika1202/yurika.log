    ...
    <nav class="category-wrapper">
        <ul class="category-item">
            ...
            <?php
                ...
                echo '<li class="_active"><a href="' . get_category_link($categories -> term_id) . '"><span class="is_ruby">日記</span>' . $categories -> name . '</a><img src="' . get_template_directory_uri() . '/img/category-line.svg" alt=""></li>';
            ?>
