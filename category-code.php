...
<main class="inner">
    ...
    <nav class="category-wrapper">
        <ul class="category-item">
            <li><a href="<?php echo esc_url(home_url('/')); ?>"><span class="is_ruby">新着記事</span>NEW</a><img src="<?php echo get_template_directory_uri() ?>/img/category-line.svg" alt=""></li>
            ...
            <?php
                ...
                echo '<li class="_active"><a href="' . get_category_link($categories -> term_id) . '"><span class="is_ruby">コードメモ</span>' . $categories -> name . '</a><img src="' . get_template_directory_uri() . '/img/category-line.svg" alt=""></li>';
            ?>
